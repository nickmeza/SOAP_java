 ...
 *         &lt;element name="pagrupa" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "wshorarioagrp")
public class Wshorarioagrp {

    protected String plengua;
    protected String pcurso;
    protected String pagrupa;
    ...
    /**
     * Obtiene el valor de la propiedad pagrupa.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPagrupa() {
        return pagrupa;
    }

    /**
     * Define el valor de la propiedad pagrupa.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPagrupa(String value) {
        this.pagrupa = value;
    }
